...
module.exports = {
    key: '20913d220b9b41cf17da56bb378048ad'
};
...
},{"./components/animalDetails/AnimalDetailsView":6,"./components/animalList/AnimalModel":10,"./components/collections/AnimalCollection":14,"./components/collections/ShelterCollection":15,"./components/collections/favoritesCollection":16,"./components/dashboard/DashboardView":17,"./components/events/dispatcher":20,"./components/favoritesPage/FavoritesView":22,"./components/myInfoPage/myInfoView":29,"./components/search/ShelterListView":30,"./components/search/ShelterModel":31,"./components/search/ShelterView":32,"./components/search/searchView":34,"backbone":1,"jquery":2}],6:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../email/fosterEmailTemplate.html":19,"../events/dispatcher":20,"../myInfoPage/MyInfoModel":27,"./animalDetailsView.html":7,"backbone":1,"jquery":2,"underscore":3}],7:[function(require,module,exports){
module.exports = "<div class=\"animal-info-section\">\n    <img class=\"animal-details-photo\" src=\"<%= media.photos.photo[3] %>\">\n\n    <div class=\"buttons\">\n        <button class=\"foster-button details-button btn\">Apply to foster me</button>\n        <button class=\"favorites-button details-button btn\">Add to favorites</button>\n    </div>\n\n    <div class=\"animal-info-section deets\">\n    <div class=\"background\">\n        <div class=\"details-section\">\n            <div class=\"font\">shelter: </div>\n            <div class=\"animal-details\"><%= contact.email %></div>\n        </div>\n        <div class=\"details-section\">\n            <div class=\"font\">name: </div>\n            <div class=\"animal-details\"><%= name %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">type: </div>\n            <div class=\"animal-details\"><%= animal %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">breed: </div>\n            <div class=\"animal-details\"><%= breeds.breed %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">age: </div>\n            <div class=\"animal-details\"><%= age %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">size: </div>\n            <div class=\"animal-details\"><%= size %></div>\n        </div>\n    </div>\n</div>\n\n</div>\n\n<!-- <div class=\"animal-info-section\">\n    <div class=\"background\">\n        <div class=\"details-section\">\n            <div class=\"font\">shelter: </div>\n            <div class=\"animal-details\"><%= contact.email %></div>\n        </div>\n        <div class=\"details-section\">\n            <div class=\"font\">name: </div>\n            <div class=\"animal-details\"><%= name %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">type: </div>\n            <div class=\"animal-details\"><%= animal %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">breed: </div>\n            <div class=\"animal-details\"><%= breeds.breed %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">age: </div>\n            <div class=\"animal-details\"><%= age %></div>\n        </div>\n\n        <div class=\"details-section\">\n            <div class=\"font\">size: </div>\n            <div class=\"animal-details\"><%= size %></div>\n        </div>\n    </div>\n</div>\n -->\n<div class=\"animal-bio-section\">\n    <div class=\"background\">\n        <div class=\"bio-section\">\n            <!-- <div class=\"font\">bio: </div> -->\n            <div class=\"animal-details bio\"><%= description %></div>\n        </div>\n    </div>\n</div>";
...
},{"./animalListItemView.html":11,"backbone":1,"jquery":2,"underscore":3}],9:[function(require,module,exports){
...
},{"../listView/ListView":26,"./AnimalListItemView":8}],10:[function(require,module,exports){
...
module.exports = "<div class=\"pet-img\" style=\"background-image: url(<%= media.photos.photo[3] %>)\"></div>\n";

},{}],12:[function(require,module,exports){
module.exports = "<div class=\"page-slot\"></div>\n<div class=\"footer-nav-view\"></div>";
...
},{"../events/dispatcher":20,"../footerNav/footerNavView":25,"./appView.html":12,"backbone":1,"jquery":2,"underscore":3}],14:[function(require,module,exports){
// animal collection
...
},{"../../api":4,"../../flattenParsedXMLAttributes":39,"backbone":1,"jquery":2}],15:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
...
// module.exports = ShelterCollection;
},{"../search/ShelterModel":31,"backbone":1,"jquery":2}],16:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../events/dispatcher":20,"backbone":1}],17:[function(require,module,exports){
var Backbone = require('backbone');
var _ = require('underscore');
var $ = require('jquery');
...
},{"../animalList/AnimalListView":9,"./dashboardView.html":18,"backbone":1,"jquery":2,"underscore":3}],18:[function(require,module,exports){
module.exports = "<div class=\"header\">Find your perfect pet!</div>\n<div class=\"available-animals-slot\"></div>";

},{}],19:[function(require,module,exports){
module.exports = "My name is <%= name %> and I would like to apply to foster your animal <%= animalName %>.\n\nI have <%= (fostered ? 'fostered' : 'not fostered') %> before and currently do <%= (pets ? 'own pets' : 'not own pets') %>.\n\nThank you for you time!\n\n<%= name %>";
...
},{"./favoritesItemView.html":23,"backbone":1,"underscore":3}],22:[function(require,module,exports){
var ListView = require('../listView/ListView');
...
},{"../collections/favoritesCollection":16,"../listView/ListView":26,"./FavoritesItemView":21}],23:[function(require,module,exports){
module.exports = "<div class=\"pet-img\" style=\"background-image: url(<%= image %>)\"></div>\n";

},{}],24:[function(require,module,exports){
module.exports = "<div class=\"nav browse\">browse</div>\n<div class=\"nav favorites\">favorites</div>\n<div class=\"nav search\">search</div>\n<div class=\"nav my-info\">my info</div>";
...
},{"./footerNavView.html":24,"backbone":1,"jquery":2,"underscore":3}],26:[function(require,module,exports){
var Backbone = require('backbone');
...
module.exports = "<div class=\"header\">My Info</div>\n\n<div class=\"background info-background\">\n    <div class=\"form-section\">\n        <label for=\"info-name\">Name</label>\n        <input type=\"text\" id=\"info-name\" class=\"info-view-input\" value=\"<%= name %>\"/>\n    </div>\n\n    <div class=\"form-section\">\n        <label for=\"info-email\">Email</label>\n        <input type=\"email\" id=\"info-email\" class=\"info-view-input\" value=\"<%= email %>\"/>\n    </div>\n\n    <div class=\"form-section\">\n        <label for=\"info-zipcode\">Zipcode</label>\n        <input type=\"text\" id=\"info-zipcode\" class=\"info-view-input info-zipcode\" value=\"<%= zipcode %>\"/>\n    </div>\n\n    <div class=\"form-section padding\">\n        <label for=\"info-fostered-before\">Have you fostered before?</label>\n        <input type=\"checkbox\" name=\"info-fostered-before\" class=\"info-view-input\"/> Yes\n    </div>\n\n    <div class=\"form-section padding\">\n        <label for=\"info-own-pets\">Do you own any pets currently?</label>\n        <input type=\"checkbox\" name=\"info-own-pets\" id=\"info-own-pets\" class=\"info-view-input\"/> Yes\n    </div>\n\n    <div class=\"form-section padding\">\n        <label for=\"info-vet\">What vet do you use?</label>\n        <input type=\"text\" id=\"info-vet\" name=\"info-vet\" class=\"info-view-input\" value=\"<%= vet %>\" />\n    </div>\n    <button class=\"info-button\">Update My Info</button>\n</div>";
...
},{"./MyInfoModel":27,"./myInfoView.html":28,"backbone":1,"jquery":2,"underscore":3}],30:[function(require,module,exports){
...
},{"./shelterListItemView":35,"./shelterListView.html":36,"backbone":1,"jquery":2,"underscore":3}],31:[function(require,module,exports){
...
},{"../collections/ShelterCollection":15,"./shelterListView":37,"./shelterView.html":38,"backbone":1,"jquery":2,"underscore":3}],33:[function(require,module,exports){
module.exports = "<div class=\"header\">Find a pet to foster!</div>\n<div class=\"search-section\">\n    <div class=\"background\">\n        <div class=\"search-by\">Search for animals in your area by type and breed</div>\n        <div class=\"search-by-animal\">\n\n            <div class=\"form-section\">\n                <label for=\"location\">Location</label>\n                <input type=\"text\" id=\"location\" class=\"search-input\" placeholder=\"zipcode or city, state\" value=\"<%= location %>\"/>\n            </div>\n\n            <div class=\"form-section\">\n                <label for=\"type\">Type</label>\n                <select id=\"type\" class=\"search-input\">\n                    <option value=\"\"></option>\n                    <option value=\"barnyard\">Barnyard</option>\n                    <option value=\"bird\">Bird</option>\n                    <option value=\"cat\">Cat</option>\n                    <option value=\"dog\">Dog</option>\n                    <option value=\"horse\">Horse</option>\n                    <option value=\"pig\">Pig</option>\n                    <option value=\"reptile\">Reptile</option>\n                    <option value=\"smallfurry\">Small & Furry</option>\n                </select>\n            </div>\n\n            <div class=\"form-section\">\n                <label for=\"breed\">Breed</label>\n                <select id=\"breed\" class=\"search-input\"></select>\n            </div>\n\n            <button id=\"animal-search\" class=\"search-button\">Search</button>\n        </div>\n    </div>\n</div>\n\n<div class=\"search-section\">\n    <div class=\"background\">\n        <div class=\"search-by form-title\">Or search by shelter</div>\n        <div class=\"search-by-location\">\n            <div class=\"form-section shelter-form\">\n                <label for=\"shelters-zipcode\">Location</label>\n                <input type=\"text\" id=\"shelters-zipcode\" class=\"search-input\" placeholder=\"zipcode or city, state\"/>\n            </div>\n        </div>\n    </div>\n</div>\n\n<div class=\"shelters-slot\"></div>\n\n<div class=\"available-animal-slot results-slot\"></div>";
...
},{"../../api":4,"../../flattenParsedXMLAttributes":39,"../animalList/AnimalListView":9,"../collections/AnimalCollection":14,"../collections/ShelterCollection":15,"./ShelterListView":30,"./searchView.html":33,"backbone":1,"jquery":2,"underscore":3}],35:[function(require,module,exports){
...
},{"../../api":4,"../../flattenParsedXMLAttributes":39,"./ShelterModel":31,"backbone":1,"jquery":2,"underscore":3}],36:[function(require,module,exports){
module.exports = "<h1 class=\"list-view-header\">Click on a shelter to view the pets available at that location</h1>";

},{}],37:[function(require,module,exports){
arguments[4][30][0].apply(exports,arguments)
},{"./shelterListItemView":35,"./shelterListView.html":36,"backbone":1,"dup":30,"jquery":2,"underscore":3}],38:[function(require,module,exports){
module.exports = "<div class=\"shelters-zipcode\">Find pets in your area by shelter: </div>\n<input type=\"text\" id=\"shelters-zipcode\" class=\"shelters-input\" placeholder=\"zipcode or city, state\"/>\n<button class=\"shelters-zipcode-button\">Search</button>\n\n<div class=\"shelters-slot\"></div>";
...
module.exports = flattenParsedXMLAttributes;
...
},{"./appRouter":5,"./components/app/appView":13,"backbone":1,"jquery":2}]},{},[40]);
